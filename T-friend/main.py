...
img_PATH = "./img/"
path_json = './json/'
RES_save_path = CF.res_folder #'/T-friend_data/RES/dev/'
RES_save_train_path = CF.train_res_folder #'/T-friend_data/TRAIN/res/'
path_2 = "./"
...
def pre_data(commend,proc, name = ''):
    ...
    if proc == 0 :
        path = CF.req_folder #'/T-friend_data/REQ/dev/'  # 전달받은 자료 경로
        if commend != 'test':
            path = CF.train_folder #'/T-friend_data/TRAIN/dev/'
